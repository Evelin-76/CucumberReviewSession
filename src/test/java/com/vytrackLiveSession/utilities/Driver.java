package com.vytrackLiveSession.utilities;
...
public class Driver {//creating Singleton concept with Driver class for Browsers

    private Driver() {}//creating private constructor for no create object through it
